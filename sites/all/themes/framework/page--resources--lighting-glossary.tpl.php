  ...
  <div class="contentMaster">
      <div class="container"> 
				<ul class="breadcrumbs">
					...
					<li class="sel">Lighting Glossary</li>
				</ul>
        <div class="sectionWrapper"> 
          <!--fullContentSection:start-->
          <div class="fullContentSection">
            <h1>Lighting <span class="semiBold">Glossary</span></h1>
            <div class="glossarySection">
              <div class="glossaryPagenation">
                <ul class="glossaryDesktop">
                </ul>
                <div class="glossaryMobile">
                  <div class="selBox">
