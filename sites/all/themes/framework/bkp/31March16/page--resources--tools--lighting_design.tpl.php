          ...
          <div class="fullContentSection">
            ...
            <div class="appStepSection">
              ...
              <div class="stepContent">
                ...
                <form id="myForm" action="<?php echo base_path(); ?>ajax-upload" method="post" enctype="multipart/form-data">
                <div class="queryForm">            
                    <div class="formWrap">              
                      <div class="fieldGroup">
                        <div class="group">
                          <div class="row">
                            <div class="clm">
                              <label>Name</label>
                              <div class="field">                        <input type="text" name="" value="">
                                <span class="errors">errors</span> </div>
                            </div>
                            <div class="clm">
                          ...
                          <div class="row">
                    <div class="inputMaster upload" rel="">
                      <div class="ovAll"><span>Upload File*</span></div>
                      <input type="file" size="40" name="myfile" style="width:175px" />
                      <input type="submit" value="Upload" class="jobResumeUpload" style="width:60px" />
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="buttonMasterG">
                      <input type="button" value="submit" name="submit" class="manual sButton">
                    </div>
                  </div>
                          <div class="row capchBox">
                            <div class="clm">
                                                    <div class="field">
                                                        ...
                                                        <div class="capchImg"><img class="imgCaptcha" id="captcha" src="/wiprolighting/captcha.php"></div>
                                                        <a id="change-image" onclick="document.getElementById('captcha').src='/wiprolighting/captcha.php?'+Math.random();document.getElementById('captcha-form').focus();" href="javascript:;">Not readable? Change text.</a>
                                                        <input type="text" placeholder="Enter Captcha code" autocomplete="off" id="captcha-form" name="captcha">
                                                        <span class="errors captchaErr">Please enter correct Captcha Code</span> </div>
                                                    </div>
                            </div>
                          <div class="row"> <a href="javascript:;" class="arrowLink resetBtn">Reset<span class="arrowIco"></span></a> <a href="javascript:;" class="arrowLink formBtn">Submit <span class="arrowIco"></span></a> </div>
                        </div>
                      </div>
                    </div>
          </div>
...
<script type="text/javascript">
	...
	(function ($) {  // document ready starts
		...
		$(document).on('click', '#factoryProceed', function() {
			$(".stepContent").eq(1).find(".semiBold").text("Factory Area");
			$('#offInd').val('Factory');
			$.ajax({
        type:'POST',
        ...
        $(".comboPck .group").each(function() {
            ...
            tableContents += '<div class="comboImg"><img alt="" src="'+image1+'"></div>';
						...
						if($(this).find(".comboInfo").eq(0).attr('uo') == 'null') {
							subArea += '<div class="clm"><label>UO</label><span class="value">0</span> </div>';
						} else {
							subArea += '<div class="clm"><label>UO</label><span class="value">'+$(this).find(".comboInfo").eq(0).attr('uo')+'</span> </div>';
						}
						subArea += '</div></div>';
          }
				...
				$.each($('.selectProduct .group'), function( index, value ) {
					if($(value).attr('set-it') == 1) {
						...
						if($(value).attr('uo') == 'null') {
							...
							subArea += '<div class="clm"><label>UO</label><span class="value">'+$(value).attr('uo')+'</span> </div>';
						}
						subArea += '</div></div>';
					}
				});
