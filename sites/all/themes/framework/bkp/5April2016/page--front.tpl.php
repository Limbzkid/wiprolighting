...
<div class="lightbox lbFeedbackForm" tabindex="-1"> <a class="closeBtn"></a>
  ...
  <div class="feedbackForm">
    ...
    <div class="row capchBox">
      ...
      <div class="fields">
        <div class="capchImg"><img src="<?php echo base_path(); ?>captcha.php" id="captcha" class="imgCaptcha"/></div>
        <a href="javascript:;" onclick="document.getElementById('captcha').src='<?php echo base_path(); ?>captcha.php?'+Math.random();document.getElementById('captcha-form').focus();"id="change-image">Not readable? Change text.</a>
        <input type="text" name="captcha" id="captcha-form" autocomplete="off" placeholder="Enter Captcha code" />
        <span class="fError captchaErr dnone">Please enter correct Captcha Code</span> </div>
      </div>
    </div>
    ...
    <div class="row">
    <div class="clm">
      <a class="arrowLink formBtn feedBackFrmSubmit" href="javascript:;" class="feedBackFrmSubmit" id="sendMail">Send <span class="arrowIco"></span></a>
      </div>
    </div>
  </div>
</div>
