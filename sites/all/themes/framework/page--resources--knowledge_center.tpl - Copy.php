...
asdasdasdasdas asd asd asd asd asd asd 
<?php $curpath = explode('/', current_path()); ?>
<?php echo 'CCCC'.  $cutpath; ?>
<header>
    ...
    <nav>
      <div class="topbar">
        <ul class="globalNav">
					...
					<?php endif;?>
					<li class="locateI"><a href="<?php echo base_path(); ?>dealer-locator/channel-partner">Locate Us</a></li>
					...
					foreach($nodes as $nod) {
						...
						if($i == 0)
						{
							...
							<div id="wpClm" style="display:none;">
							  <h2><?php echo $nod->title; ?></h2>
							  <a class="actionLink" target="_blank" href="<?php echo file_create_url($nod->field_pdf_file['und'][0]['uri']); ?>"><i class="fa fa-file-pdf-o"></i> Download</a>
							...
							?>
								...
								<div class="wpClm" dspl="<?php echo $j; ?>" tid="<?php if($field_application) { echo $field_application; } ?>" <?php if($i == 1){ echo 'style ="border-top: none;"'; } else if($j >= 1){ echo 'style ="display: none;"'; }  ?>>
								  <h2><?php echo $nod->title; ?></h2>
								  <a class="actionLink" target="_blank" href="<?php echo file_create_url($nod->field_pdf_file['und'][0]['uri']); ?>"><i class="fa fa-file-pdf-o"></i> Download</a>
								  <p><?php echo $nod->body['und'][0]['value']; ?></p>
								</div>
